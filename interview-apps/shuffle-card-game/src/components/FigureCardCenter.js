...
// Center image of figure card(J Q K)
const FigureCardCenter = ({ name, number }) => {
  const FigureContent = () => {
    console.log("FigureCardCenter: ", number, name);
    switch (number) {
      case 11:
        if (name === "spade") return <JackOfSpade />;
        if (name === "club") return <JackOfClub />;
        if (name === "heart") return <JackOfHeart />;
        if (name === "diamond") return <JackOfDiamond />;
        break;
      case 12:
        if (name === "spade") return <QueenOfSpade />;
        if (name === "club") return <QueenOfClub />;
        if (name === "heart") return <QueenOfHeart />;
        if (name === "diamond") return <QueenOfDiamond />;
        break;
      case 13:
        if (name === "spade") return <KingOfSpade />;
        if (name === "club") return <KingOfClub />;
        if (name === "heart") return <KingOfHeart />;
        if (name === "diamond") return <KingOfDiamond />;
        break;
      default:
        break;
    }
